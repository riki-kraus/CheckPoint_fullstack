...
//           fetchedAnswers.forEach((val: Answer, j: number) => {
...
//               answer += `❌ שאלה ${val.section} - התשובה הנכונה היא: ${answers[j]?.correctAnswer} ●\n`;
//             } else {
...
//               score: newMark,
//               fileUrl: fileExamUrl,
//               fileUrlFeedback: filFeedbackUrl
//             });
//             allExams.push(exam);
...
//             files[i]=null;
//             setFiles(files);
//             // Add to unregistered students list
...
//     checkTests();
//   }, [selectedImages, setExams, setStudents, setMarks, setAnswers]);
