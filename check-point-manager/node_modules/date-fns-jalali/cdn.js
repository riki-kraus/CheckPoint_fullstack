...
__export(exports_date_fns_jalali, {
  ...
  newDate: function newDate() {return newDate8;},
...
function normalizeDates(context) {for (var _len5 = arguments.length, dates = new Array(_len5 > 1 ? _len5 - 1 : 0), _key5 = 1; _key5 < _len5; _key5++) {dates[_key5 - 1] = arguments[_key5];}
  var normalize = context || _constructFrom.bind(null, dates.find(function (date) {return _typeof(date) === "object";}));
...
function newDate8(year, monthIndex, date) {var hours = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;var minutes = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;var seconds = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 0;var ms = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 0;
...
//# debugId=4479EFD9FFC5C3A264756E2164756E21
